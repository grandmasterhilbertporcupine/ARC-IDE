...
const hostDaemonOnlineRpcResponseSuccessSchema = z.discriminatedUnion(
  "commandType",
  [
    onlineRpcResponseSuccessSchemaFor("terminal.probePreview"),
    onlineRpcResponseSuccessSchemaFor("terminal.stopPreview"),
    ...
    commandRpcResponseSuccessSchemaFor("turn.stop-if-current"),
