...
export const SURFACE_GROUPS: SurfaceGroup[] = [
    ...
    surfaces: [
      {
        ...
        summary:
          "Replaces ARC's navigation controls above the thread list with a component your plugin renders. With this, a plugin can:",
        bullets: [
          ...
          "Render ARC's original controls when the plugin wants to delegate",
          "Leave the thread list, footer, drawer, and resize handle under ARC's control",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        summary:
          "Adds a row to ARC's sidebar that opens a page your plugin renders where threads normally appear. With this, a plugin can:",
        bullets: [
          "Render any React you write across that whole area",
          "Get its own URL, so the page can be linked to and ARC's back and forward buttons work",
          "Register tabs in the panel to the right of its page, beside ARC's own Browser and Terminal tabs",
        ],
      ...
      },
      {
        ...
        summary:
          "Replaces the list of threads in ARC's sidebar with a component your plugin renders. With this, a plugin can:",
        bullets: [
          "Render every row, and decide the grouping, the ordering, and what each row shows",
          "Read the same live thread data and run statuses ARC's own list reads",
          "Replace only the list. The New thread button, the search action, the plugin rows, and the sidebar footer stay ARC's",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        summary:
          "Adds a host-rendered icon item to the bottom of ARC's sidebar. With this, a plugin can:",
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Render in the same row as ARC's own header controls",
        ],
      ...
      {
        id: "thread-companion",
        title: "Thread companion views",
        summary:
          "Adds an optional view beside the existing chat and composer. With this, a plugin can:",
        bullets: [
          "Receive the exact selected thread and project while core owns the Chat switch and URL history",
          "Mount a companion only when selected without replacing the main conversation",
          "Measure the preserved main chat through a stable DOM anchor and retain bounded view state through host URL history",
          "Publish batched identity labels and counters for visible thread rows, once per represented project",
        ],
        apiSymbols: [
          "ExperimentalThreadViewProps",
          "ExperimentalThreadViewRegistration",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Receive the entry data and plugin payload, plus ARC's default content as `Original`",
          "Fall back to ARC's default content automatically when the plugin is unavailable or crashes",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        summary:
          "Replaces ARC's source-code or diff renderer everywhere that kind of content appears. With this, a plugin can:",
        bullets: [
          "Register the source-code and diff replacements independently",
          "Apply each replacement across ARC's file previews, timeline and environment diffs, and plugin pages",
          "Hand any individual render back to ARC's built-in renderer, and fall back to it automatically if the plugin is unavailable or crashes",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Add plugin-owned elements to app pages without taking ownership of ARC's built-in layout",
  ...
  },
  {
    ...
    fixtureKind: "spatial",
    blurb:
      "ARC's searchable command menu. A plugin can add actions that match, rank, and run alongside ARC's own commands.",
    surfaces: [
      {
        id: "command-palette-actions",
        title: "Command palette actions",
        summary:
          "Adds a row under Plugins in ARC's quick command palette. With this, a plugin can:",
        bullets: [
    ...
    surfaces: [
      ...
      },
      {
        ...
        apiSymbols: [
          ...
          "ExperimentalAddressedDispatchHandler",
        ],
      ...
      },
      {
        ...
        summary:
          "Adds an agent to ARC's model picker and runs the threads started with it. With this, a plugin can:",
        bullets: [
          "Appear in the model picker beside ARC's built-in providers",
        ...
        apiSymbols: [
          ...
          "experimental_killProcessGroup",
          "experimental_supportsProcessGroups",
          "experimental_resolveWindowsPowerShell",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Render in the same row as ARC's own prompt-box buttons. If you have more than 3 plugins enabled, bb keeps the 3 most-used plugins inline and moves the rest into an overflow menu",
        ],
    ...
    surfaces: [
      {
        ...
        bullets: [
          ...
          "Render after ARC's own content, in the order plugins registered",
        ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Orchestration",
        surfaceIds: ["prepared-workers", "prepared-turns", "internal-rpc"],
      },
      {
        title: "Confidence",
        surfaceIds: ["testing"],
    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          "Register tools an agent calls the same way it calls ARC's built-in tools",
          ...
          "Bind an immutable plugin execution context at thread creation and validate its full instructions before the first provider call",
        ],
        apiSymbols: [
          "PluginAgents",
          "PluginAgentConfigurationContext",
          "PluginAgentConfiguration",
          "ExperimentalAssignedSkillSnapshot",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Count tokens and embed bounded text through the installed offline Context runtime, with explicit availability, exact helper-generation admission and cancellable requests",
        ],
        apiSymbols: [
          "PluginHosts",
          ...
          "ExperimentalContextEmbeddingDescriptor",
          "ExperimentalContextEmbeddingFailure",
      ...
      },
      {
        ...
        title: "The bb SDK",
        summary:
          "Calls ARC's own API from the plugin's server code. With this, a plugin can:",
        bullets: [
          "Create threads, send messages to them, and manage projects",
          "Retry a saved addressed Send with bb.sdk.threads.experimental_retryAddressed, preserving its original operation, recipients and attachments",
      ...
      },
      {
        ...
        tagline: "Use your automation tool on ARC-owned tabs",
        summary:
        ...
        bullets: [
          ...
          "Use bounded native CDP evaluation on Windows through the Node SDK and bb browser evaluate without installing another automation runtime",
      ...
      },
      {
        ...
        summary:
          "Save and supervise a project preview using ARC-owned persistent terminals.",
        bullets: [
        ...
        firstParty: ["Preview panel"],
        experimental: true,
      },
      {
        id: "ai-services",
        tagline: "Serve ARC's helper model from your own machine",
        title: "AI services",
        summary:
          "Lets a plugin answer ARC's own helper-model calls — the short model calls behind thread titles and commit messages, and the microphone button's transcription. With this, a plugin can:",
        bullets: [
          "Serve those calls from an enrolled machine, so ARC's helper model can be one the plugin holds the credentials for",
      ...
      {
        id: "host-components",
        tagline: "Embed ARC's chat and prompt box",
        title: "Host components",
        summary:
          "Renders ARC's own conversation and prompt-box components inside the plugin's pages. With this, a plugin can:",
        bullets: [
          ...
          "Inherit ARC's styling, so embedded UI matches the rest of the app",
        ],
        apiSymbols: [
          "ThreadChat",
          "Markdown",
      ...
      },
      {
        ...
        summary:
          "Reserves and provisions a plugin-owned worker before admitting its first provider turn. With this, a plugin can:",
        bullets: [
          "Seal the operation, context, input and execution tuple",
          "Observe durable preparation and native request identity",
          "Release once under the retained revision and environment",
          "Enforce one admitted turn for orchestration budgets",
          "Keep owned child notifications passive until owner admission",
        ],
        apiSymbols: [
          "ExperimentalPreparedThreads",
          "ExperimentalPrepareThreadRequest",
          "ExperimentalThreadPreparation",
          "ExperimentalPreparedThreadDispatch",
          "ExperimentalPreparedThreadEnvironment",
          "ExperimentalPrepareThreadEnvironment",
      ...
      {
        id: "prepared-turns",
        title: "Prepared conversation turns",
        summary:
          "Admits one immutable owned response in an existing idle conversation. With this, a plugin can:",
        bullets: [
          "Retain owner, operation, context and native request identity",
          "Configure only the admitted input without changing the conversation origin",
          "Cancel before dispatch or conditionally stop the exact native input",
          "Distinguish proven manual tool invocations from owned automatic turns",
        ],
        apiSymbols: [
      ...
      {
        id: "internal-rpc",
        title: "Internal plugin RPC",
        summary:
          "Calls another server plugin with a validated contract and core-supplied caller identity. With this, a plugin can:",
        bullets: [
          "Keep registrations out of public HTTP, CLI and agent routes",
          "Fence caller and target plugin generations",
          "Abort handlers before plugin disposal",
        ],
        apiSymbols: [
          "ExperimentalInternalRpcContext",
          "ExperimentalInternalRpcHandlers",
          "ExperimentalInternalRpcClient",
        ],
        firstParty: ["ARC", "Workflows"],
        experimental: true,
      },
      {
        id: "testing",
