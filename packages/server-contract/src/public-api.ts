import type { RefreshFilePreviewResponse } from "./api/files.js";
import { z } from "zod";
import {
  configurePreviewRequestSchema,
...
export const publicApiRoutes = {
  ...
  filePreviews: {
    refresh: defineRoute({
      path: "/file-previews/:id/refresh",
      method: "post",
      request: jsonRequest<PathId, EmptyInput>(previewActionRequestSchema),
      response: jsonResponse<RefreshFilePreviewResponse>(),
    }),
    content: defineRoute({
  ...
  previews: {
    detach: defineRoute({
      path: "/projects/:id/preview/detach",
      method: "post",
      request: jsonRequest<PathId, DetachPreviewRequest>(
        detachPreviewRequestSchema,
      ),
      response: jsonResponse<ProjectPreview>(),
    }),
    get: defineRoute({
    ...
    configure: defineRoute({
      path: "/projects/:id/preview/configure",
      method: "post",
      request: jsonRequest<PathId, ConfigurePreviewRequest>(
        configurePreviewRequestSchema,
      ),
      response: jsonResponse<ProjectPreview>(),
    }),
    start: defineRoute({
      path: "/projects/:id/preview/start",
      method: "post",
      request: jsonRequest<PathId, EmptyInput>(previewActionRequestSchema),
      response: jsonResponse<ProjectPreview>(),
    }),
    stop: defineRoute({
      path: "/projects/:id/preview/stop",
      method: "post",
      request: jsonRequest<PathId, EmptyInput>(previewActionRequestSchema),
      response: jsonResponse<ProjectPreview>(),
    }),
    restart: defineRoute({
      path: "/projects/:id/preview/restart",
      method: "post",
      request: jsonRequest<PathId, EmptyInput>(previewActionRequestSchema),
      response: jsonResponse<ProjectPreview>(),
    }),
  ...
  threads: {
    ...
    experimental_retryAddressed: defineRoute({
      path: "/threads/:id/retry-addressed",
      method: "post",
      request: jsonRequest<
        PathId,
        { operationId: string; senderThreadId?: string }
      >(
        z
          .object({
