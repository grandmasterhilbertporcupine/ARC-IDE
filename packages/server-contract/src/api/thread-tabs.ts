...
export const browserHtmlPreviewSourceSchema = z
  .object({
    ...
    filePath: z
      ...
      .refine(
        ...
        "HTML path must be relative to its preview root",
      ),
  })
  .strict();
export type BrowserHtmlPreviewSource = z.infer<
  typeof browserHtmlPreviewSourceSchema
>;
