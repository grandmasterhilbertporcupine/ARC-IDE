...
describe("file-preview", () => {
  it("recognizes both HTML extensions without treating script or archive names as HTML", () => {
    expect(isHtmlFilePreviewPath("C:\\Project Δ\\index.HTM")).toBe(true);
    expect(isHtmlFilePreviewPath("page.html")).toBe(true);
    expect(isHtmlFilePreviewPath("page.html.js")).toBe(false);
  });
