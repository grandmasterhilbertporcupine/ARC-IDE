...
import {
  browserHtmlPreviewSourceSchema,
  type BrowserHtmlPreviewSource,
...
const browserFixedPanelTabSchema = z
  .object({
    ...
    htmlSource: browserHtmlPreviewSourceSchema.optional(),
  ...
  switch (a.kind) {
    ...
    case "browser":
      return (
        ...
        a.environmentId === b.environmentId &&
        a.htmlSource?.hostId === b.htmlSource?.hostId &&
        a.htmlSource?.rootPath === b.htmlSource?.rootPath &&
        a.htmlSource?.filePath === b.htmlSource?.filePath &&
        a.url === b.url &&
        a.title === b.title
      );
    case "thread-storage-file-preview":
