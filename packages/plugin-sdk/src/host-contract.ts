...
import type { HostContextEmbeddings } from "@bb/host-daemon-contract";
export {
  contextEmbeddingLimits as experimental_contextEmbeddingLimits,
  contextEmbeddingDescriptorSchema as experimental_contextEmbeddingDescriptorSchema,
  contextEmbeddingFailureSchema as experimental_contextEmbeddingFailureSchema,
  contextEmbeddingInputSchema as experimental_contextEmbeddingInputSchema,
  contextEmbeddingStatusSchema as experimental_contextEmbeddingStatusSchema,
  contextTokenCountResultSchema as experimental_contextTokenCountResultSchema,
  contextEmbeddingResultSchema as experimental_contextEmbeddingResultSchema,
} from "@bb/host-daemon-contract";

export type {
  ContextEmbeddingDescriptor as ExperimentalContextEmbeddingDescriptor,
  ContextEmbeddingFailure as ExperimentalContextEmbeddingFailure,
  ContextEmbeddingInput as ExperimentalContextEmbeddingInput,
  ContextEmbeddingStatus as ExperimentalContextEmbeddingStatus,
  ContextTokenCountResult as ExperimentalContextTokenCountResult,
  ContextEmbeddingResult as ExperimentalContextEmbeddingResult,
  ContextEmbeddingOptions as ExperimentalContextEmbeddingOptions,
  HostContextEmbeddings as ExperimentalHostContextEmbeddings,
} from "@bb/host-daemon-contract";
...
> {
  ...
  /** Fixed offline embeddings; status initializes a helper, while count/embed require its exact expectedGeneration and never create a replacement. Each operation uses its signal and the worker lifecycle. Background work must retain the worker. Hard cancellation may reject other queued embeddings, never unrelated host effects. */
  readonly experimental_contextEmbeddings: HostContextEmbeddings;
