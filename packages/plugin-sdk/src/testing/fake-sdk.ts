...
function withSpawnAttribution(pluginId: string, args: unknown[]): unknown[] {
  ...
  if (
    spawnArgs.experimental_executionContextId !== undefined &&
    ((spawnArgs.origin !== undefined && spawnArgs.origin !== "plugin") ||
      (spawnArgs.originPluginId !== undefined &&
        spawnArgs.originPluginId !== pluginId))
  ) {
    throw new Error(
