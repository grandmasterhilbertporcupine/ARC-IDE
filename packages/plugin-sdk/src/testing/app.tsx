 ...
 *   collector (ported from the ARC app's interpreter, same error messages)
...
/** Same shape (and checks) as the ARC app's real definePluginApp. */
...
/**
 * Testing Library result plus ARC-specific helpers. Direct members are
