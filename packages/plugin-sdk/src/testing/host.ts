...
import { contextEmbeddingsHarness } from "./context-embeddings.js";
...
export interface ExperimentalCreateHostEntryHarnessOptions {
  readonly experimental_contextEmbeddings?: ExperimentalHostContextEmbeddings;
    ...
    async experimental_call(methodName, input, options = {}) {
      ...
      try {
        ...
        const rawOutput = await handler(workerInput, {
          ...
          experimental_contextEmbeddings: contextEmbeddingsHarness(
            lifecycleController.signal,
            harnessOptions.experimental_contextEmbeddings,
          ),
