...
export interface StopTurnIfCurrentArgs {
  threadId: string;
  expectedClientRequestId: ClientTurnRequestId;
  expectedTurnId: string | null;
}

export interface StopTurnIfCurrentResult {
  status: "stopped" | "already-settled" | "not-current" | "unknown";
...
export interface AgentRuntime {
  ...
  stopTurnIfCurrent(
    args: StopTurnIfCurrentArgs,
  ): Promise<StopTurnIfCurrentResult>;
