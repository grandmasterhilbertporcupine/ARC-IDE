...
export const PLUGIN_CATALOG_CATEGORIES = [
  {
    ...
    description: "Personalize how ARC looks and feels.",
  },
  {
  ...
  },
  {
    ...
    description: "Work with shells and command-line programs inside ARC.",
  },
  {
    id: "utilities",
    displayName: "Utilities",
    description: "Inspect or control the computers ARC runs on.",
  },
  {
    id: "plugin-development",
    displayName: "Plugin Development",
    description:
      "Understand, inspect, build, or debug ARC and its plugin surfaces.",
  },
  {
