...
export const builtInThemes: readonly BuiltInThemeMeta[] = [
  { id: "default", name: "Default", description: "The standard ARC look" },
...
export const appSurfaceStyleSchema = z.enum(["default", "liquid-glass"]);
export type AppSurfaceStyle = z.infer<typeof appSurfaceStyleSchema>;
export const defaultAppSurfaceStyle: AppSurfaceStyle = "default";
...
export const appThemeSchema = z.object({
  ...
  surfaceStyle: appSurfaceStyleSchema.default(defaultAppSurfaceStyle),
...
export const appThemeSelectionSchema = z.object({
  themeId: z.string().min(1),
  faviconColor: faviconColorPreferenceSchema,
  surfaceStyle: appSurfaceStyleSchema.optional(),
});
