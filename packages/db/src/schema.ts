...
export const threads = sqliteTable(
  "threads",
  {
    ...
    experimental_executionContextId: text("execution_context_id"),
...
export const threadPreparations = sqliteTable(
  "thread_preparations",
  {
    ownerPluginId: text("owner_plugin_id").notNull(),
    operationId: text("operation_id").notNull(),
    threadId: text("thread_id").notNull(),
    requestHash: text("request_hash").notNull(),
    requestJson: text("request_json").notNull(),
    ownerGeneration: text("owner_generation").notNull(),
    ...
    provisioningContextJson: text("provisioning_context_json"),
    environmentJson: text("environment_json"),
    acceptedRevision: integer("accepted_revision"),
    queuedMessageId: text("queued_message_id"),
    clientTurnRequestId: text("client_turn_request_id"),
    reason: text("reason"),
    createdAt: integer("created_at").notNull(),
    updatedAt: integer("updated_at").notNull(),
  },
  (table) => [
    primaryKey({ columns: [table.ownerPluginId, table.operationId] }),
    uniqueIndex("thread_preparations_thread_idx").on(table.threadId),
    uniqueIndex("thread_preparations_queue_idx").on(table.queuedMessageId),
    index("thread_preparations_owner_generation_idx").on(
      table.ownerPluginId,
...
export const threadTurnPreparations = sqliteTable(
  "thread_turn_preparations",
  {
    ownerPluginId: text("owner_plugin_id").notNull(),
    operationId: text("operation_id").notNull(),
    ...
    revision: integer("revision").notNull(),
    acceptedRevision: integer("accepted_revision"),
    interruptRevision: integer("interrupt_revision"),
    queuedMessageId: text("queued_message_id"),
    clientTurnRequestId: text("client_turn_request_id"),
  ...
  (table) => [
    primaryKey({ columns: [table.ownerPluginId, table.operationId] }),
    uniqueIndex("thread_turn_preparations_queue_idx").on(table.queuedMessageId),
    uniqueIndex("thread_turn_preparations_request_idx").on(
      table.clientTurnRequestId,
    ),
    index("thread_turn_preparations_thread_state_idx").on(
      table.threadId,
      table.state,
    ),
    index("thread_turn_preparations_owner_generation_idx").on(
      table.ownerPluginId,
      table.ownerGeneration,
    ),
  ],
