...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    {...usePortalScopeProps()}
    className={cn(
      "arc-overlay-motion arc-backdrop-motion fixed inset-0 z-50 bg-black/40 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className,
    )}
    {...props}
  />
