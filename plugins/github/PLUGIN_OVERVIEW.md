See the open issues and pull requests of your repositories inside ARC. Hand one to an agent with one click.
...
- Send agent on an issue, or Review with agent on a pull request. ARC starts a thread in the repository's project and links it from the item.
