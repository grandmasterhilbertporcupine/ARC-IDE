...
export default function plugin(bb: BbPluginApi) {
  bb.experimental_aiServices.register({
    id: "codex",
    displayName: "OpenAI API helpers (API key required)",
  ...
  bb.settings.define({
    memoryEnabled: {
      ...
      label: "Codex memory",
      description:
        "Allow Codex to recall existing memories and generate new memories from ARC threads.",
      default: true,
    },
    subagentsDisabled: {
      type: "boolean",
      ...
      description:
        "Prevent Codex from starting native subagents so agents use ARC for delegation.",
      default: false,
    },
  });
