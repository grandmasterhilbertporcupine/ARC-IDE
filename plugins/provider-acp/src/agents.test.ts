...
describe("acpProviderDeclaration", () => {
  ...
  it("keeps each agent's own reasoning ladder while exposing onboarding", () => {
    ...
    expect(grok.experimental_visibility).toBe("always");
    ...
    expect(cursor.maintenance?.usage).toBe(false);
