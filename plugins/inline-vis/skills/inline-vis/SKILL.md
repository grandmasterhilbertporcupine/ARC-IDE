---
name: inline-vis
description: "Render a workspace HTML artifact inline in ARC chat using the inline-vis directive."
---
...
- Inline and external CSS/JavaScript are supported. Remote images, fonts,
  ...
  opaque-origin iframe and cannot access the ARC page, cookies, or storage.
...
The ARC app replaces the directive with a sandboxed preview. If the plugin is
