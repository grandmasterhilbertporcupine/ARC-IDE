  ...
  return (
    <MockSidebarPanel>
      <div className="flex min-h-0 flex-1 flex-col px-2 py-2">
        <div className="flex h-8 items-center px-2 text-sm font-semibold">ARC plugins</div>
...
const NEW_THREAD_ACTIONS = [
  ...
  { icon: "Explore", title: "Learn what ARC can do", description: "Get a tour of its capabilities" },
] as const;
    ...
    <div style={{ flex: 1, minWidth: 0, minHeight: 0, background: v("canvas", v("background")), color: v("foreground"), display: "flex", flexDirection: "column", fontFamily: SANS, position: "relative" }}>
      {empty ? (
        <div data-tp-new-welcome="" style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: narrow ? 22 : 34, padding: `0 ${pad}px` }}>
          <img src="/api/v1/plugins/theme-preview/assets/logo" alt="ARC" className={narrow ? "size-14 object-contain" : "size-20 object-contain"} />
        ...
        <>
          <div style={{ height: 48, display: "flex", alignItems: "center", gap: 10, padding: `0 ${pad}px`, flex: "none", position: "relative" }}>
            ...
            {narrow ? null : <Badge tone="outline">arc/endless-theme-plugin</Badge>}
          </div>
      ...
      <div data-tp-thread-info="" className="flex min-h-0 flex-1 flex-col">
        ...
        <div className="flex flex-col gap-3.5 px-4 py-3.5">
          <div>
            ...
            {kv("Directory", <span style={{ fontFamily: MONO, fontSize: 12 }}>~/Code/ARC</span>)}
            {kv("Branch", <span style={{ fontFamily: MONO, fontSize: 12 }}>arc/endless-theme</span>)}
        ...
        <section style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ borderRadius: RADIUS_LG, border: `1px solid ${v("border")}`, background: v("card"), padding: "14px 16px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              {row("Palette", "Palettes change ARC's colors, including syntax colors in diffs and file previews. Choose a built-in palette or create one from a prompt.", control("Palette", themeName))}
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: 6, fontFamily: MONO, fontSize: 12, color: v("muted-foreground") }}>arc/endless-theme</div>
