...
const SHARED_FIXTURE_ANCHORS: readonly FixtureAnchor[] = [
  ...
  },
  {
    ...
    because: "Mock thread and settings rows keep ARC's shared row geometry and rest, hover, selected, and split states.",
  },
  {
    ...
    because: "Mock sidebars use ARC's shared button primitive, section-label token, padding, and project-row anatomy.",
  },
  {
...
export const VIEW_FIXTURE_ANCHORS = {
  thread: [
    ...
    },
    {
      ...
      because: "The thread projection exposes the same fixed secondary-panel tabs as ARC.",
    },
    {
      ...
      because: "The open Info panel projects ARC's flat metadata card and representative environment, branch, and pull-request rows.",
    },
    {
  ...
  new: [
    {
      ...
      because: "The New thread projection uses ARC's current empty-welcome actions, hierarchy, and hover state.",
    },
  ],
  split: [
    {
      ...
      because: "The Split projection keeps ARC's pane identity, focus state, divider, and inactive-pane wash.",
    },
  ],
  settings: [
    {
      ...
      because: "The Appearance projection uses ARC's settings navigation hierarchy and selected-row state.",
    },
    {
      file: "apps/app/src/components/settings/settings-sections.ts",
      mustContain: ['{ icon: "Palette", id: "appearance", label: "Appearance" }'],
      because: "The settings navigation keeps Appearance as a first-class ARC settings destination.",
    },
    {
      ...
      mustContain: [
        ...
        'label="Palette"',
        "Palettes change ARC's colors, including syntax colors in diffs and file previews.",
        'label="Favicon color"',
        "<SplitDimmingSetting />",
      ],
      because: "The Appearance projection keeps ARC's current theme, palette, favicon, and inactive-split controls.",
    },
    {
      ...
      because: "The Appearance projection keeps ARC's section card, responsive rows, and supporting-copy hierarchy.",
    },
  ],
