Tell every agent on this ARC host the things you would otherwise repeat in each thread. Examples: your coding conventions, the tools you prefer, and the projects it should know about.
...
Write the instructions as plain text or Markdown. Leave the field empty to add nothing. ARC appends your text to the instructions it already gives the agent.
