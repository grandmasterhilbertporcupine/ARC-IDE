---
name: memory
description: "Retrieve relevant durable ARC memories or save verified knowledge useful to future threads."
---
...
memories for the current ARC project. The index contains summaries only.
...
The CLI uses ARC's loopback server, which Claude's macOS workspace sandbox
