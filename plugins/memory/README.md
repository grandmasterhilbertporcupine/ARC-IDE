...
Durable, progressively disclosed agent memory for ARC. It
provides:
...
duplicated or conflicting memories split between Codex, Claude Code, and ARC.
...
Install Memory from the Included with ARC catalog:
...
Project writes take the invoking CLI's ARC project context. Global writes must
