...
import {
  ...
  ownedMigration,
  ownedControlMigration,
  ownedValidationMigration,
  ownedValidationRequestMigration,
  ownedContinuationMigration,
  ownedRuleContinuationMigration,
  ownedThreadLookupMigration,
} from "./owned-data.js";
...
export const migrations = [
  ...
  ownedMigration,
  `ALTER TABLE workflow_owned_runs ADD COLUMN failure_requested INTEGER NOT NULL DEFAULT 0;`,
  ownedControlMigration,
  ownedValidationMigration,
  ownedValidationRequestMigration,
  ownedContinuationMigration,
...
export function claimQueuedRun(
  ...
  return db.transaction(() => {
    if (countActiveWorkflowRuns(db) >= maxActiveRuns) return null;
