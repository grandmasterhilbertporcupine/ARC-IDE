...
export default function plugin(bb: BbPluginApi) {
  bb.settings.define({
    memoryEnabled: {
      ...
      description:
        "Allow Claude Code to read and write its native auto-memory for ARC threads.",
      default: true,
    },
    subagentsDisabled: {
      type: "boolean",
      ...
      description:
        "Hide Claude Code's native Task tool so agents use ARC for delegation.",
      default: false,
    },
    workflowsDisabled: {
      type: "boolean",
      label: "Disable Workflow tool",
      description: "Hide Claude Code's native Workflow tool for ARC threads.",
      default: false,
    },
