        ...
        return {
          ...
          hookSpecificOutput: {
            ...
            permissionDecisionReason:
              "ARC has disabled Claude Code native subagents; use ARC delegation instead.",
          },
        };
      }
      if (
        ...
        return {
          ...
          hookSpecificOutput: {
            ...
            permissionDecision: "deny",
            permissionDecisionReason:
              "ARC has disabled the Claude Code Workflow tool.",
          },
        };
      }
    }
...
function buildSessionEnv(
  ...
  const sessionEnv: NodeJS.ProcessEnv = {
    ...
    ...envOverrides,
    CLAUDE_AGENT_SDK_CLIENT_APP: "arc/0.1.0",
  };
