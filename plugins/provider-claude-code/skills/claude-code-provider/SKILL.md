...
description: "Configure or troubleshoot ARC-specific Claude Code provider settings and session behavior."
---
...
- `idleQueryReleaseEnabled` defaults to `false`. When enabled, the native process
  closes after 30 seconds of quiescence while the ARC thread remains resumable.
