...
export const CREATE_AUTOMATION_PROMPT = "Create a new ARC automation to ";
...
export function AutomationOverviewView({
  ...
  return (
    <ResourceCollectionPage
      ...
      description="Manage scheduled ARC work across projects and folders. Automations run recurring or one-time tasks without manual prompting."
      modes={[
        {
          id: "installed",
          label: "Installed",
