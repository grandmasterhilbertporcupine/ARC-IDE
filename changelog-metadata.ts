...
export const RELEASE_META: Record<string, ReleaseMeta> = {
  ...
  "0.42.8": {
    ...
    headline: "Consistent ARC branding and offline release notes",
  },
  "0.42.7": {
    date: "September 14, 2026",
    headline: "Your choice of shortcuts and launch options",
  },
  "0.42.6": {
    date: "September 14, 2026",
    headline: "Clearer collapsed navigation",
  },
  "0.42.5": {
    date: "September 14, 2026",
    headline: "Animated ARC setup",
  },
  "0.42.4": {
    date: "September 14, 2026",
    headline: "ARC on the Windows desktop",
  },
  "0.42.0": {
