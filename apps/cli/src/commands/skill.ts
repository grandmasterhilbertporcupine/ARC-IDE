...
export function registerSkillCommands(
  ...
  skill
    ...
    .description("Install a canonical skills.sh entry into ARC user skills")
    .option("--json", "Print machine-readable JSON output")
    .action(
      action(async (registrySkillId: string, options: JsonOutputOptions) => {
  ...
  skill
    ...
    .description(
      "Show whether each machine has ARC's built-in CLI skills installed",
    )
    .option(
      "--machine <id-or-name>",
  ...
  skill
    ...
    .description(
      "Install ARC's built-in CLI skills into ~/.agents/skills and ~/.claude/skills on a machine",
    )
    .option(
      "--machine <id-or-name>",
