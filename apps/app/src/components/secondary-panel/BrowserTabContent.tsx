import { BrowserFeedbackControls } from "./BrowserFeedbackControls";
...
function BrowserUnavailable() {
  return (
    <div className="flex h-full flex-col items-center justify-center gap-3 px-6 text-center">
      ...
      >
        The in-app web browser runs in the ARC desktop app. Open this thread
...
export function BrowserTabContent({
  ...
  useEffect(() => {
    ...
    if (navigateOnAttach) desktopBrowser.navigate({ tabId, url: mountUrl });
    ...
    <div data-app-browser className="flex h-full min-h-0 flex-col">
      {showProjectPreview && (
        <ProjectPreviewControls
          ...
          onNavigate={navigateToInput}
          visible={canShowNativeBrowserView}
        />
      )}
      <BrowserChrome
