...
const SIDEBAR_MOBILE_DRAG_SETTLE_MS = 180;
const SIDEBAR_MOBILE_REALIZE_TIMEOUT_MS = 1000;
const SIDEBAR_MOBILE_DRAG_SETTLE_EASING = "cubic-bezier(0.2, 0, 0, 1)";
...
const SIDEBAR_MOBILE_SHELF_INSET_TRANSITION_CLASS =
  "max-md:[transition:translate_180ms_cubic-bezier(0.2,0,0,1)] motion-reduce:transition-none!";
const SIDEBAR_MOBILE_BACKDROP_TRANSITION_CLASS =
  "[transition:opacity_180ms_cubic-bezier(0.2,0,0,1),translate_180ms_cubic-bezier(0.2,0,0,1)]";
const SIDEBAR_GROUP_LABEL_BASE_CLASS =
  "duration-200 flex shrink-0 items-center rounded-md px-1 text-xs font-medium text-sidebar-foreground/75 outline-none ring-sidebar-ring transition-[margin,opacity] ease-[cubic-bezier(0.2,0,0,1)] focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0";
    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={widthStyle}
          className={cn(
            "relative hidden h-full w-(--sidebar-width) bg-transparent transition-[width] duration-[180ms] ease-[cubic-bezier(0.2,0,0,1)] motion-reduce:transition-none md:block",
        ...
        <div
          data-sidebar="panel"
          className={cn(
            "fixed inset-y-0 z-10 flex h-(--bb-shell-height) w-(--sidebar-width) select-none flex-col bg-sidebar text-sidebar-foreground [transition:left_180ms_cubic-bezier(0.2,0,0,1),right_180ms_cubic-bezier(0.2,0,0,1),width_180ms_cubic-bezier(0.2,0,0,1),visibility_0s_linear_0s]",
            "group-data-[collapsible=offcanvas]:invisible group-data-[collapsible=offcanvas]:[transition:left_180ms_cubic-bezier(0.2,0,0,1),right_180ms_cubic-bezier(0.2,0,0,1),width_180ms_cubic-bezier(0.2,0,0,1),visibility_0s_linear_180ms]",
