  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-subtle-foreground">
        ...
        machine that runs it, not to this ARC server.{" "}
        {reason === "disabled"
      ...
      <DialogHeader>
        ...
        <DialogDescription>
          {unreachable !== null
            ...
            : "Run this command on the machine you want to add. It installs the machine helper and keeps the machine connected to this server."}
        </DialogDescription>
      </DialogHeader>
