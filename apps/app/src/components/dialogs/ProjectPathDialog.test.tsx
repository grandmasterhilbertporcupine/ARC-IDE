  ...
  it.each([
    {
      ...
      placeholder: "C:\\Projects\\Forecast",
      description: "absolute Windows path",
    },
    {
      platform: "wsl" as const,
      placeholder: "/path/to/project",
      description: "absolute WSL path",
    },
  ])(
    "shows $platform path guidance without confusing native Windows and WSL",
    ({ platform, placeholder, description }) => {
      render(
        <ProjectPathDialog
          target={{ kind: "create" }}
          platform={platform}
      ...
      expect(
        screen.getByText((content) => content.includes(description)),
      ).toBeDefined();
    },
  );
