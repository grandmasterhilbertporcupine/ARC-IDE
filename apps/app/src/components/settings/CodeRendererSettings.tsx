...
export function CodeRendererSettings() {
  ...
  return (
    <>
      <CodeRendererSetting
        label="Source code"
        description="Choose automatic activation, ARC's viewer, or a specific plugin on this device."
        builtInDescription="Syntax highlighting and gutters from the ARC code theme."
      ...
      <CodeRendererSetting
        ...
        builtInDescription="Unified and split diffs from the ARC code theme."
