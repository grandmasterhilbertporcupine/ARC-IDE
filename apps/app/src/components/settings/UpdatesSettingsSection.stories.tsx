    ...
    <SettingsStoryChrome activeSection="updates" contentOwnsPageShell>
      ...
      >
        ...
        <State
          ...
          note="ARC cannot currently reach this machine."
        >
        ...
        <State
          name="Update available"
          note="ARC has an installer it can run for this provider."
        >
        ...
        <State
          ...
          note="The CLI was installed outside ARC, so the update must run in its own package manager."
        >
        ...
        <State
          ...
          note="The machine is connected, but ARC could not inspect its provider CLIs."
        >
