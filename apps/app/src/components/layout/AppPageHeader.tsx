...
export function useAppHeaderChrome(ownsWindowTopLeft = true) {
  ...
  return {
    usesDesktopChrome,
    sidebarReserveClass: shouldReserveSidebarTrigger
...
export function AppPageHeader({
  ...
  const { usesDesktopChrome, sidebarReserveClass } =
    useAppHeaderChrome(ownsWindowTopLeft);
  return (
    <header
      ref={headerRef}
      className={cn(
