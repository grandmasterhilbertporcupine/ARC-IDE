...
function providerFilterLabel(
  ...
  return provider === "bb" ? "ARC" : providerLabel(provider, providerRoster);
}
...
const SKILLS_BROWSE_DESCRIPTION = (
  <>
    ...
    . Install one and every agent you use in ARC can run it.
  </>
);
const SKILLS_LIBRARY_DESCRIPTION =
  "The skills on this ARC host — yours, your providers', and those bundled with plugins. They work with every agent you use in ARC.";
      ...
      <ResourceRow
        ...
        titleMeta={
          skill.scope === "bb-builtin" ? (
            <ProvenancePill label="Included with ARC" />
          ) : skill.scope === "plugin" ? (
            <ProvenancePill
              label="Included"
              tooltip={
      ...
      titleBadge={
        skill.scope === "bb-builtin"
          ? {
              ...
              tooltip: "Ships with ARC",
              accessibleLabel: `${skill.name} is Included with ARC`,
            }
