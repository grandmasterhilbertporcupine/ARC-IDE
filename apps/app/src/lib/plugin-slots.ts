...
export interface PluginRegistrationSet {
  ...
  threadViews?: readonly ExperimentalThreadViewRegistration[];
  threadListAnnotations?: readonly ExperimentalThreadListAnnotationsRegistration[];
...
export interface ExperimentalThreadViewSlot
  extends ExperimentalThreadViewRegistration, PluginSlotBase {}
export interface ExperimentalThreadListAnnotationsSlot
  extends ExperimentalThreadListAnnotationsRegistration, PluginSlotBase {}
...
export interface PluginSlotSnapshot {
  ...
  threadViews: readonly ExperimentalThreadViewSlot[];
  threadListAnnotations: readonly ExperimentalThreadListAnnotationsSlot[];
...
function flattenRegistrations(
  ...
  return {
    ...
    threadViews: stamp(set.threadViews),
    threadListAnnotations: stamp(set.threadListAnnotations),
