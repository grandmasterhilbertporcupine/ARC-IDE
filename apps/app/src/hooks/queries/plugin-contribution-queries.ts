...
import { experimentalRecipientIdentitySchema } from "@bb/domain";
import {
...
function isMentionSearchItem(value: unknown): value is PluginMentionSearchItem {
  ...
  return (
    ...
    (item.experimental_recipient === undefined ||
      experimentalRecipientIdentitySchema.safeParse(item.experimental_recipient)
        .success)
  );
}
