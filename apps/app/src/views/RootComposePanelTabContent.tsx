...
interface RootComposePanelTabContentProps {
  ...
  onOpenBrowser: (url?: string, source?: BrowserHtmlPreviewSource) => void;
    ...
    case "workspace-file-preview": {
      ...
      original =
        tab.environmentId !== null ? (
          <LazyWorkspaceFilePreviewTabContent
            onOpenHtmlPreview={
              onOpenBrowser ? (source) => onOpenBrowser("", source) : undefined
            }
            activePath={tab.path}
            copyPath={copyPath}
          ...
          <LazyProjectFilePreviewTabContent
            htmlSource={
              projectPreviewHostId && projectPreviewRootPath
                ? {
                    hostId: projectPreviewHostId,
