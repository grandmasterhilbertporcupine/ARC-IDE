  ...
  return (
    <div className="flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-clip">
      <SecondaryPanelLayout
        ...
        mainHeader={header}
        main={
          <div className="@container/thread-companion flex h-full min-h-0 min-w-0 flex-1 flex-col">
            <div className="flex min-h-0 min-w-0 flex-1 flex-col @[900px]/thread-companion:flex-row">
              <div
                id={mainElementId}
                data-thread-main-chat=""
                className="flex min-h-0 min-w-0 flex-1 flex-col"
              >
                <ThreadTimelinePane {...timeline} footer={footer} />
              </div>
              {companion ? (
                <div className="flex min-h-0 min-w-0 flex-1 flex-col border-t border-border @[900px]/thread-companion:border-t-0 @[900px]/thread-companion:border-l">
                  {companion}
                </div>
              ) : null}
            </div>
