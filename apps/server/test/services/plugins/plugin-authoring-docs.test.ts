...
type SlotPropsByName = {
  ...
  experimental_threadView: ExperimentalThreadViewProps;
  experimental_threadListAnnotations: ExperimentalThreadListAnnotationsProps;
...
const FRONTEND_SLOT_PROP_FIELDS = {
  ...
  experimental_threadListAnnotations: ["projectId", "threadIds", "onChange"],
