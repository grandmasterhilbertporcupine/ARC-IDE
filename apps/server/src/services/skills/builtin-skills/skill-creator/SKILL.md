---
name: skill-creator
description: "Create or improve ARC skills, including their triggers, instructions, and supporting resources."
---
...
ARC loads names and descriptions for discovery, the body when a skill is used,
