---
name: bb-cli
description: "Inspect or manage ARC state with the bb CLI; use for ARC commands and configuration."
---

# ARC CLI

Use bb for ARC state and actions. Inspect context when the target project, host,
...
Keep this skill and its references focused on core ARC commands. Plugin-specific
