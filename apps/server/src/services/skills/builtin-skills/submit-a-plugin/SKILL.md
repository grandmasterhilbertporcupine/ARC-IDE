...
description: "Prepare and submit an ARC plugin to the Community marketplace when publication or a marketplace PR is requested."
---

# Submit a plugin

Submit a public plugin to the Community marketplace. The marketplace stores
...
The marketplace contract can change independently from ARC releases. Read these
...
Use scripts/derive-plugin-id.mjs to calculate the same plugin ID that ARC uses:
