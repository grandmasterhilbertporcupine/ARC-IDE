...
description: "Create or change ARC plugins and Plugin SDK extensions, including CLI commands, agent tools, providers, and UI surfaces."
---

# Author ARC plugins

An ARC plugin is a TypeScript package that can add server behavior, agent
...
routes to detailed references, but the installed ARC version decides the exact
API.
