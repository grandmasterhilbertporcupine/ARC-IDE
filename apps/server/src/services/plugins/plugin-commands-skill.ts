...
function renderPluginCommandsSkill(
  ...
  return [
    "---",
    `name: ${SKILL_NAME}`,
    "description: Discover CLI commands contributed by installed ARC plugins and their invocation paths.",
    "---",
    "",
    "# Plugin Commands",
    "",
    "Installed ARC plugins contribute commands; core-name collisions use the explicit plugin-id form while others use a top-level `bb` subcommand.",
