...
export const bundleTargets = [
  {
    ...
    entryPoint: resolve(packageRoot, "src", "context", "client.ts"),
    label: "Context client",
    outfile: resolve(packageRoot, "dist", "context", "client.mjs"),
  },
  {
    banner: NODE_ESM_REQUIRE_BANNER,
    entryPoint: resolve(packageRoot, "src", "context", "worker.ts"),
    label: "Context worker",
    outfile: resolve(packageRoot, "dist", "context", "worker.mjs"),
    externalPackages: [
